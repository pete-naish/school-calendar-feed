...
const GROUPS = [
  ...
  { label: "Year 4", dot: "dot-year4", colorVar: "--cal-5", classes: [{ code: "y4-a", label: "4W" }, { code: "y4-b", label: "4Y" }] },
  { label: "Year 5", dot: "dot-year5", colorVar: "--cal-6", classes: [{ code: "y5-a", label: "5HP" }, { code: "y5-b", label: "5M" }] },
